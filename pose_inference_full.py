...
from myNetFull import myNetFull 
...
def load_model(model_path, num_classes=3):
    ...
    model = myNetFull(num_classes=num_classes).to(device)
...
def parse_opt():
    ...
    parser.add_argument('--model', type=str, default='./resnet_full.pth', help='Path to the trained model')
